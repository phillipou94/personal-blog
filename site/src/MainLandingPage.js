...
import TwoColContactUsWithIllustration from "components/forms/TwoColContactUsWithIllustration.js";
...
export default ({
  ...
  heading = "Hi 👋",
  description = "I'm Phil. I live in Brooklyn and when I'm not doing my day job, I'm moonlighting as blogger and a (wannabe) chef. Welcome to my online diary of everything I'm thinking about or working on!"
}) => {
  /*
